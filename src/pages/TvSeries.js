...
const TvSeries = () => {
    let [data,setData] = useState(cardsObj.filter(card => card.category === "TV Series" && card.carousel === undefined))
    let [result, setResult] = useState("TV Series")
    ...
    function filterData(e) {
        ...
        setData(data = filteredData.filter(item => {return item.category === "TV Series" }))
        if(currentValue === '') {
            setResult(result = 'TV Series')
        } else {
    ...
    return (
        <div className="main-wraper">
            <Navigation color="#5A698F" color2="#5A698F" color3="#FFFFFF" color4="#5A698F"/>
                ...
                <div className="container">
                    <div className="search">
                        <div className="searchInputs"> 
                            ...
                            <input placeholder="Search for TV Series..." onChange={filterData} type="text"/>
                        </div>
